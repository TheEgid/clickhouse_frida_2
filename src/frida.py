...
class FridaLangChainAdapter:
    """Адаптер для Clickhouse в LangChain"""
    def __init__(self, embed_model: FridaEmbedding):
        self.embed_model = embed_model

    def embed_query(self, text: str):
        return self.embed_model._get_query_embedding(text)

    def embed_documents(self, texts: list[str]):
        return [self.embed_model._get_text_embedding(t) for t in texts]
